...
import mongoImage from '../assets/about/Python logo.png';
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <p className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-red-50">
            Hi, my name is <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">Bhavya Raparthi</span>, a passionate Computer Science Engineering student at ANITS. I am interested in full-stack development, AI, and machine learning. I enjoy building web applications and intelligent systems, and I am always eager to learn new technologies, improve my problem-solving skills, and work on real-world projects.
          </p>
